...
<div id="nav">
	<ul>
		<li><a href="send_e1_psc.php">Create File</a></li>
		<li><a href="inbox_e1_psc.php">Inbox (
			<?php
			$dbConnect = mysqli_connect('localhost', 'root', 'ak_94*jmv', 'edpr');
			$qry_appr = "SELECT COUNT(*) FROM e1_psc_edpr WHERE status ='Pending'";
...
?>
		...
		<li><a href="outbox_e1_psc.php">Outbox (
			<?php
			$dbConnect = mysqli_connect('localhost', 'root', 'ak_94*jmv', 'edpr');
