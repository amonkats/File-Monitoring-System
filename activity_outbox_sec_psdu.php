...
<script type="text/javascript">
	...
	$search_Query = "SELECT serialno, refno, file_origin, subject FROM outbox_sec_psdu WHERE serialno='$search'";
	...
	<select id="deliver" name="receiver" required="required" class="headings" style="width: 220px; height: 40px;">
		...
		if ($_POST['receiver'] == 'Ag. C/EDP&RD') {
   		...
   		if ($_POST['receiver'] == 'E1/MPA') {
   			include 'sent_files_e1_mpa.php';
   		}

   		if ($_POST['receiver'] == 'E2/MPA') {
   			include 'sent_files_e2_mpa.php';
   		}

   		if ($_POST['receiver'] == 'E3/MPA') {
   			include 'sent_files_e3_mpa.php';
   		}

   		if ($_POST['receiver'] == 'GE/MPA') {
   			include 'sent_files_ge_mpa.php';
   		}

   		if ($_POST['receiver'] == 'RE/MPA') {
   			include 'sent_files_re_mpa.php';
   		}
   		...
   		if ($_POST['receiver'] == 'M&E/PSDU') {
   			include 'sent_files_me_psdu.php';
   		}
