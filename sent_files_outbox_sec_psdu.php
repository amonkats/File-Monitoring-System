<?php
	 ...
	 if ($refno2 == '') {
	 	$sql2="INSERT INTO outbox_sec_psdu(serialno, refno, file_origin, subject, Date_received) VALUES($rand,'None','$origin2','$subject2', '$date')";
	 ...
	 $sql2="INSERT INTO outbox_sec_psdu(serialno, refno, file_origin, subject, Date_received) VALUES($rand,'$refno2','$origin2','$subject2', '$date')";
	 $query2=mysqli_query($dbConnect, $sql2);
	 if(!$query2){
		 echo "<p style='color: white;'>Error in Insertion of records</p>".mysqli_error($dbConnect); 
