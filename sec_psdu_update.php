...
<section style="background: #142634; color: #fff;"><br>
   ...
   $search_Query = "SELECT serialno, refno, file_origin, subject FROM outbox_sec_psdu WHERE serialno='$searchId'";
...
?>
   ...
   <form action="" method="post">
     ...
     <input type="text" name="refno" required="" placeholder="Ref No" value="<?php echo $row[1];?>" style="width: 220px; height: 40px;"><br><br>

     <textarea type="text" cols="40" rows="6" placeholder="Origin" name="origin" style="width: 342px; height: 97px;"><?php echo htmlentities($row[2]); ?></textarea>

     <textarea type="text" cols="40" rows="6" placeholder="Subject" name="subject" style="width: 342px; height: 97px;"><?php echo htmlentities($row[3]); ?></textarea><br>


    <input type="submit" name="updatebtn" value="Edit" style="width: 185px; height: 45px;"><br><br>

   </form>

   <?php
   if(isset($_POST['updatebtn'])){
      include('sec_psdu_edit.php');
   }
?>
