...
<script type="text/javascript">
	...
	$search_Query = "SELECT serialno, refno, file_origin, subject FROM re_mpa_edpr WHERE serialno='$search'";
...
?>
	...
	<select id="deliver" name="receiver" required="required" class="headings" style="width: 220px; height: 40px;">
		...
		if ($_POST['receiver'] == 'Ag. C/EDP&RD') {
   			include 'sent_files_re_mpa_comm.php';
   		}

   		if ($_POST['receiver'] == 'Ag. AC/EDP&RD') {
   			include 'sent_files_re_mpa_ass_comm.php';
   		}

   		if ($_POST['receiver'] == 'SEC/EDP&RD ') {
   			include 'sent_files_re_mpa_sec_edpr.php';
   		}


   		//Private Sector Competitiveness  (PSC)  Section
   		if ($_POST['receiver'] == 'PE/PSC') {
   			include 'sent_files_re_mpa_pe_psc.php';
   		}

   		if ($_POST['receiver'] == 'SE/PSC') {
   			include 'sent_files_re_mpa_se_psc.php';
   		}

   		if ($_POST['receiver'] == 'E1/PSC') {
   			include 'sent_files_re_mpa_e1_psc.php';
   		}

   		if ($_POST['receiver'] == 'E2/PSC') {
   			include 'sent_files_re_mpa_e2_psc.php';
   		}

   		if ($_POST['receiver'] == 'E3/PSC') {
   			include 'sent_files_re_mpa_e3_psc.php';
   		}

   		if ($_POST['receiver'] == 'RE1/PSC') {
   			include 'sent_files_re_mpa_re1_psc.php';
   		}

   		if ($_POST['receiver'] == 'RE2/PSC') {
   			include 'sent_files_re_mpa_re2_psc.php';
   		}

   		if ($_POST['receiver'] == 'RA/PSC') {
   			include 'sent_files_re_mpa_ra_psc.php';
   		}


   		//Development Policy Analysis (DPA) Section
   		if ($_POST['receiver'] == 'SE1/DPA') {
   			include 'sent_files_re_mpa_se1_dpa.php';
   		}

   		if ($_POST['receiver'] == 'SE2/DPA') {
   			include 'sent_files_re_mpa_se2_dpa.php';
   		}

   		if ($_POST['receiver'] == 'E1/DPA') {
   			include 'sent_files_re_mpa_e1_dpa.php';
   		}

   		if ($_POST['receiver'] == 'E2/DPA') {
   			include 'sent_files_re_mpa_e2_dpa.php';
   		}

   		if ($_POST['receiver'] == 'RE/DPA') {
   			include 'sent_files_re_mpa_re_dpa.php';
   		}

   		if ($_POST['receiver'] == 'RA/DPA') {
   			include 'sent_files_re_mpa_ra_dpa.php';
   		}


   		//Micro Policy Analysis (MPA) Section
   		if ($_POST['receiver'] == 'SE/MPA') {
   			include 'sent_files_re_mpa_se_mpa.php';
   		}

   		if ($_POST['receiver'] == 'E1/MPA') {
   			include 'sent_files_re_mpa_e1_mpa.php';
   		}

   		if ($_POST['receiver'] == 'E2/MPA') {
   			include 'sent_files_re_mpa_e2_mpa.php';
   		}

   		if ($_POST['receiver'] == 'E3/MPA') {
   			include 'sent_files_re_mpa_e3_mpa.php';
   		}

   		if ($_POST['receiver'] == 'GE/MPA') {
   			include 'sent_files_re_mpa_ge_mpa.php';
   		}
   		...
   		if ($_POST['receiver'] == 'H/PSDU') {
   			include 'sent_files_re_mpa_h_psdu.php';
   		}

   		if ($_POST['receiver'] == 'SCA/PSDU') {
   			include 'sent_files_re_mpa_sca_psdu.php';
   		}

   		if ($_POST['receiver'] == 'MRP/PSDU') {
   			include 'sent_files_re_mpa_mrp_psdu.php';
   		}

   		if ($_POST['receiver'] == 'MEGD/PSDU') {
   			include 'sent_files_re_mpa_megd_psdu.php';
   		}

   		if ($_POST['receiver'] == 'M&E/PSDU') {
   			include 'sent_files_re_mpa_me_psdu.php';
   		}

   		if ($_POST['receiver'] == 'SEC/PSDU') {
   			include 'sent_files_re_mpa_sec_psdu.php';
   		}
