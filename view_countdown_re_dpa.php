...
<html>
<head>
	<title>EDP&RD File Monitoring System</title>	<!--<link rel="stylesheet" type="text/css" href="style.css">-->
	<style type="text/css">
		body{
			background: #fff;
		}
...
<?php 
	...
	$search_Query = "SELECT due_days FROM re_dpa_edpr WHERE serialno='$countdownId'";
