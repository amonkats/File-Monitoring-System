...
<section style="background: #142634; color: #fff;"><br>
	...
	$search_Query = "SELECT serialno, file_origin, subject, status FROM sec_edpr WHERE serialno='$updateId'";
...
?>
	...
	<form action="" method="post">
	 ...
	 <!--<input type="text" name="status_two" required="required" placeholder="status_two" value="<?php //echo $row[5];?>" style="width: 220px; height: 40px;">-->

	  <select name="status" required="required" placeholder="Status" value="<?php echo $row[3];?>" style="width: 220px; height: 40px;">
