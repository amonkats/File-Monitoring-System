<?php
  ...
  if(isset($_POST['deletebtn'])){
      ...
      $sql_update="DELETE FROM ass_comm_edpr WHERE serialno='$data[1]'";
    ...
    try{
      ...
      if($update_result){
        if(mysqli_affected_rows($dbConnect) > 0){
          ...
          echo "<p style='color: red;'>"; echo"<i>"; echo "<script type='text/javascript'> window.alert('You do not have permission to delete this file !');</script>"; echo"</i>"; echo "</p>"; echo"</i>"; echo "</p>".mysql_error();
        }
      }
