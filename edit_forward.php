<?php
	...
	if(isset($_POST['updatebtn'])){
			$dbConnect = mysqli_connect('localhost', 'root', 'ak_94*jmv', 'edpr');
			$data=getPosts();
			$sql_update="UPDATE outbox_sec_edpr SET origin='$data[2]', subject='$data[3]', status='$data[6]' WHERE ref_no='$data[1]'";
		...
		try{
			...
			if($update_result){
				...
				}else{echo "<p style='color: red;'>"; echo"<i>"; echo "Status not Updated"; echo"</i>"; echo "</p>";}
			}
