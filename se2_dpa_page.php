 ...
 <img src="images/arms.jpg">
	...
	<?php 
	 ...
	 if (isset($_POST['btnsearch'])) {
	 		...
	 		$query = "SELECT * FROM `se2_dpa_edpr` WHERE CONCAT(`serialno`, `refno`, `file_origin`, `subject`, `sender`, `receiver`, `action`, `due_days`, `forward`, `date_sent`, `status` , `delete_file`) LIKE '%".$search_term."%'";
	 		$search_result = filterTable($query);
	 		$search_item = test_input($_POST['valueToSearch']);
	 	}

	 else{
	 		$query = "SELECT * FROM se2_dpa_edpr";
	 		$search_result = filterTable($query);
	 	}
	 ...
	 <?php
		...
		<tr>
			...
			<?php
				...
				?>
				<td style="text-align: center;"><?php echo $row1[7];?> | <a href="view_countdown_se2_dpa.php?countdownId=<?php echo $row1[0];?>" style="color: blue; text-decoration: none;"><i>View</i></a>
			...
			<td><a href="activity_se2_dpa.php?searchId=<?php echo $row1[0];?>" style="color: blue; text-decoration: none;"><?php echo $row1[8];?></a></td>

			<td><?php echo $row1[9];?></td>

			<?php
			if ($row1[10] == 'Done') {?>
				<td><?php echo $row1[10];?> | <a href="update_assign_se2_dpa.php?updateId=<?php echo $row1[0];?>" style="color: blue; text-decoration: none;"><i>Update </i></td>

				<?php }?>
			<?php 
			if($row1[10] == 'Pending'){?>
				<td><b><label style="color: red"><?php echo $row1[10];?></label></b> | <a href="update_assign_se2_dpa.php?updateId=<?php echo $row1[0];?>" style="color: blue; text-decoration: none;"><i>Update</i></a></td>

				<?php }?>

				<td><a href="se2_dpa_delete.php?searchId=<?php echo $row1[0];?>" style="color: blue; text-decoration: none;"><?php echo $row1[11];?></a></td>
